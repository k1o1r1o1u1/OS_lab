...
void main()
{
    ...
    int completed = 0, curIndex = -1, curTime = p[0].AT;
    int *waitQ, front = 0, rear = -1;

    waitQ = (int *)malloc(n * sizeof(int));
    ...
    while (completed != n)
    {
        ...
        else
        {
            ...
            p[curIndex].WT =
                p[curIndex].TAT - tempBT[p[curIndex].Id - 1];
